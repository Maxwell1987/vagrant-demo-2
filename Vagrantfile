...
Vagrant.configure("2") do |config|
  ...
  config.vm.box_server_url = "http://192.168.10.252"
  #config.vm.box_url = "http://192.168.10.252/ubuntu/boxes/xenial64/metadata.json"
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    echo 'Acquire::http::Proxy "http://192.168.10.252:3142";' > /etc/apt/apt.conf.d/00aptproxy
    echo '#Acquire::http::Proxy::apt.dockerproject.org "DIRECT";' >> /etc/apt/apt.conf.d/00aptproxy
